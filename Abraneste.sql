...
EXEC agregarSolicitud 3, 5, 5, 'Fabricar un escritorio de madera', 'Finalizado', '2025-10-15', NULL;
EXEC agregarSolicitud 1, 1, 1, 'Instalar luces LED en cocina y living.', 'Finalizado', '2024-02-02', '2024-02-04', '2024-02-01';
EXEC agregarSolicitud 2, 2, 2, 'Reparar pérdida de agua en baño.', 'Finalizado', '2024-02-05', '2024-02-06', '2024-02-04';
EXEC agregarSolicitud 3, 3, 3, 'Pintar dormitorio principal.', 'En Progreso', '2024-02-10', NULL, '2024-02-09';
EXEC agregarSolicitud 1, 4, 4, 'Construir estante de madera.', 'Pendiente', NULL, NULL, '2024-02-10';
EXEC agregarSolicitud 4, 5, 5, 'Podar árboles del jardín.', 'Finalizado', '2024-02-15', '2024-02-16', '2024-02-14';
EXEC agregarSolicitud 5, 6, 6, 'Abrir cerradura trabada.', 'Finalizado', '2024-02-18', '2024-02-18', '2024-02-17';
EXEC agregarSolicitud 6, 7, 7, 'Revisión de instalación de gas.', 'Finalizado', '2024-02-20', '2024-02-21', '2024-02-19';
EXEC agregarSolicitud 7, 8, 8, 'Colocar cerámicos en baño.', 'En Progreso', '2024-02-25', NULL, '2024-02-24';
EXEC agregarSolicitud 8, 9, 9, 'Reparar filtración en techo.', 'Pendiente', NULL, NULL, '2024-02-26';
EXEC agregarSolicitud 9, 10, 10, 'Soldar portón de entrada.', 'Finalizado', '2024-02-28', '2024-02-29', '2024-02-27';
EXEC agregarSolicitud 10, 11, 11, 'Reemplazar vidrio de ventana.', 'Finalizado', '2024-03-01', '2024-03-02', '2024-02-29';
EXEC agregarSolicitud 1, 12, 12, 'Corte y color completo.', 'Finalizado', '2024-03-03', '2024-03-03', '2024-03-02';
EXEC agregarSolicitud 12, 13, 13, 'Cambio de bujías y aceite.', 'Finalizado', '2024-03-04', '2024-03-05', '2024-03-03';
EXEC agregarSolicitud 13, 14, 14, 'Pasear perro 2 horas.', 'Finalizado', '2024-03-06', '2024-03-06', '2024-03-05';
EXEC agregarSolicitud 14, 15, 15, 'Revisión de notebook.', 'Pendiente', NULL, NULL, '2024-03-06';
EXEC agregarSolicitud 1, 1, 1, 'Revisar instalación eléctrica completa.', 'Finalizado', '2024-03-08', NULL, '2024-03-07';
EXEC agregarSolicitud 2, 2, 2, 'Instalar nuevo termotanque.', 'Finalizado', '2024-03-10', '2024-03-11', '2024-03-09';
EXEC agregarSolicitud 1, 3, 3, 'Pintar cocina y pasillo.', 'En Progreso', '2024-03-15', NULL, '2024-03-14';
EXEC agregarSolicitud 1, 9, 9, 'Reparar gotera en techo.', 'Finalizado', '2024-03-20', '2024-03-21', '2024-03-19';
EXEC agregarSolicitud 3, 4, 4, 'Armar mueble modular.', 'Pendiente', NULL, NULL, '2024-03-21';
GO
...
EXEC agregarDetalle 5, 'Mal servicio', 3,1;(1, 'Excelente trabajo, prolijo y rápido.', 5, 5, '2024-02-05',
...
CREATE FUNCTION buscarInactivos(@IDproveedor INT)
RETURNS NVARCHAR(10)
AS
BEGIN
	DECLARE @resultado NVARCHAR
	IF EXISTS (SELECT 1 FROM Proveedor WHERE IDProveedor = @IDproveedor AND Estado = 'Inactivo')
		SET @resultado = 'TRUE';
	ELSE 
		SET @resultado = 'FALSE';
	RETURN @resultado;
...
DROP FUNCTION buscarInactivos;
SELECT buscarInactivo 1 AS inactivos;
...
------------------------------------------------------------------------------------------------------------------------------
CREATE OR ALTER FUNCTION dbo.TotalDiasTrabajadosProveedor(@idProveedor INT)
RETURNS INT
AS
BEGIN
